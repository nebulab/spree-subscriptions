...
[![Build Status](https://secure.travis-ci.org/nebulab/spree-subscriptions.png?branch=2-4-stable)](http://travis-ci.org/nebulab/spree-subscriptions)
...
```ruby
gem 'spree_subscriptions', github: 'nebulab/spree-subscriptions', branch: '2-4-stable'
```
