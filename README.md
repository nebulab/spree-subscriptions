...
[![Build Status](https://secure.travis-ci.org/nebulab/spree-subscriptions.png?branch=1-2-stable)](http://travis-ci.org/nebulab/spree-subscriptions)
...
```ruby
gem 'spree_subscriptions', :git => 'git://github.com/nebulab/spree-subscriptions.git', :branch => '1-2-stable'
```
